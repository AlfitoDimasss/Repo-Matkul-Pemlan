...
// Class Trapesium yang merupakan turunan class TrapesiumGenjang
public class Trapesium extends TrapesiumGenjang {
     ...
     */
    public Trapesium(double tinggi, double sisi1, double sisi2, double sisi3, double sisi4, double xAwal, double yAwal,
            String arahX, String arahY, double delta) {
        super(tinggi, sisi1, sisi2, sisi3, sisi4, xAwal, yAwal, arahX, arahY, delta);
    }

    // Method hitung luas
    public void hitungLuas() {
        double luas = ((this.getAB() + this.getCD()) * this.getTinggi()) / 2;
        this.setLuas(luas);
    }
