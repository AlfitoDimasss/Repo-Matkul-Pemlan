...
public class KapalSelam extends KendaraanLaut {
    ...
    public KapalSelam(int kode, double panjang, double lebar, double tinggi, String merek, int jumlah, String alatGerak,
            boolean menyelam, boolean militer) {
        super(kode, panjang, lebar, tinggi, merek, jumlah, alatGerak, menyelam);
