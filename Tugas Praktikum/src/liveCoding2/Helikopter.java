...
public class Helikopter extends KendaraanUdara {
    ...
    public Helikopter(double panjang, double lebar, double tinggi, String merek, int jumlah, double tinggiMaks,
            double baling) {
        super(panjang, lebar, tinggi, merek, jumlah, tinggiMaks);
